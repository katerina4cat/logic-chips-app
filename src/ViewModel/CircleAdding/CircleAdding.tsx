        ...
        return (
            ...
            >
                {this.props.elements.map((element, i) => {
                    const x1 = Math.cos(this.getAngle(i)) * 30 + 50;
                    const y1 = Math.sin(this.getAngle(i)) * 30 + 50;
                    const x2 = Math.cos(this.getAngle(i + 1)) * 30 + 50;
                    const y2 = Math.sin(this.getAngle(i + 1)) * 30 + 50;
                    return (
                        <>
                            <path
